...
import { ABOUT_COPPA_POINTS, ABOUT_MEDIA } from "@/data/about";

import { ShieldIcon } from "./about-icons";

/** Parent-supervision (COPPA) band: reassuring headline + three control points. */
export function AboutCoppa() {
  return (
