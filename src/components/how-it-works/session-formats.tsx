      ...
      <div className="grid grid-cols-2 gap-7 max-[760px]:grid-cols-1">
        {SESSION_FORMATS.map((format, index) => (
          <Reveal key={format.tag} delay={(index + 1) as RevealDelay}>
            <article className="group overflow-hidden rounded-[20px] border border-line bg-ivory shadow-[0_30px_60px_-40px_rgba(24,24,24,0.25)] transition-[transform,box-shadow] duration-500 ease-brand hover:-translate-y-2 hover:shadow-[0_40px_76px_-32px_rgba(24,24,24,0.32)]">
